    ...
    <!-- <div class="container">
          ...
          <div class="row">
             ...
             <div class="col-md-3- col-md-offset-1">
               <h2 style="float-right">SideBar</h2>
             </div>
          </div>
    </div>
  <div class="container">
              ...
              <div class="col-md-12">
                ...
                <form>
                   <div class="form-group">
                     ...
                     <input id="Email" name="Email" value="form-control">
                   </div>
                   <div class="form-group">
                     <label name="subject">Subject:</label>
                     <input id="subject" name="subject" value="form-control">
                   </div>
                   <div class="form-group">
                     <label name="message">Message:</label>
                     <textarea id="message" name="message" value="form-control"></textarea>
                   </div>
